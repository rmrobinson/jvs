...
type BridgePersister interface {
	...
	CreateBridge(context.Context, *pb.BridgeConfig) (string, error)
...
func (db *BridgeDB) CreateBridge(ctx context.Context, config *pb.BridgeConfig) (string, error) {
	// Populate the bridge
...
func (db *BridgeDB) Bridge(ctx context.Context) (*pb.Bridge, error) {
...
func (db *BridgeDB) SetBridgeConfig(ctx context.Context, config *pb.BridgeConfig) error {
...
func (db *BridgeDB) SetBridgeState(ctx context.Context, state *pb.BridgeState) error {
	return ErrNotSupported
}

func (db *BridgeDB) devicesCustomQuery(ctx context.Context, query string) ([]*pb.Device, error) {
	...
	for rows.Next() {
		...
		isBinary := false
		bs := &pb.DeviceState_BinaryState{}
		isRange := false
		rs := &pb.DeviceState_RangeState{}
...
//  - Value (Range State)
func (db *BridgeDB) CreateDevice(ctx context.Context, device *pb.Device) error {
	...
	if device.Config == nil {
		device.Config = &pb.DeviceConfig{}
	}
	if device.State == nil {
		device.State = &pb.DeviceState{}
	}
...
func (db *BridgeDB) SetDeviceConfig(ctx context.Context, dev *pb.Device, config *pb.DeviceConfig) error {
